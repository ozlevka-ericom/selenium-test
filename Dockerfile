...
RUN apt-get update \
    ...
    && wget https://github.com/ozlevka-ericom/selenium-test/releases/download/Test/chrome64_67.0.3396.79.deb \
    && wget https://github.com/ozlevka-ericom/selenium-test/releases/download/Test/chromedriver_linux64.zip \
